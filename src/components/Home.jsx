                        ...
                        filteredProducts.map((product) => {
                            ...
                            return (
                                <div className="col" key={id}>
                                    {/* Karty automatycznie dostosują tło w Dark Mode */}
                                    <div className={`card h-100 shadow-sm ${!productAvailable ? 'opacity-75' : ''}`}>

                                        {/* ZMIANA: text-dark -> text-reset */}
                                        <Link to={`/product/${id}`} className="text-decoration-none text-reset">
                                            ...
                                            <div className="card-body d-flex flex-column">
                                                ...
                                                {/* text-muted jest OK, bootstrap sam go rozjaśni w dark mode */}
